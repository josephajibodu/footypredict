...
export default function Authenticated({
    ...
    console.log('bottom nav is hidden: ', hideBottomNav ? 'true' : 'false')
    ...
    return (
        <div className="flex flex-col h-screen bg-primary/20">
            ...
            {(!hideBottomNav) && (
                <nav className="max-w-md mx-auto text-white bg-black border-b border-gray-100 dark:bg-gray-800 fixed bottom-0 right-0 left-0">
